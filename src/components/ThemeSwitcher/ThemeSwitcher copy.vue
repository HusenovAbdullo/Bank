        ...
        <Slideover.Description class="p-0">
          <div class="flex flex-col">
            <!-- <div class="px-8 pt-6 pb-8">
              <div class="text-base font-medium">Mavzular</div>
              <div class="mt-0.5 text-slate-500">Kerakli mavzuni tanlang</div>
                ...
                <div v-for="theme in themes">
                  <a @click="(event: MouseEvent) => {
                    ...
                    <div class="w-full h-full overflow-hidden rounded-md image-fit">
                      <img class="w-full h-full" :src="themeImages[
            ...
            <!-- <div class="px-8 pt-6 pb-8">
              <div class="text-base font-medium">Tartiblar</div>
                ...
                <div v-for="layout in layouts">
                  <a @click="(event: MouseEvent) => {
                    ...
                    <div class="w-full h-full overflow-hidden rounded-md">
                      <img class="w-full h-full" :src="layoutImages[
