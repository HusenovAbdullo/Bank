      ...
      <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 mt-8">
          <div class="flex items-center h-10 intro-y">
            <h2 class="mr-5 text-lg font-medium truncate">Umumiy hisobot</h2>
            <a href="" class="flex items-center ml-auto text-primary">
              <Lucide icon="RefreshCcw" class="w-4 h-4 mr-3" /> Ma'lumotlarni qayta yukalash
            </a>
          </div>
          <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div :class="[
                ...
                <div class="p-5 box">
                  <div class="flex">
                    <Lucide icon="UsersIcon" class="w-[28px] h-[28px] text-primary" />
                    <div class="ml-auto">
                      <Tippy as="div"
                  ...
                  <div class="mt-1 text-base text-slate-500">Umumiy kelgan xabarlar</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div :class="[
                ...
                <div class="p-5 box">
                  <div class="flex">
                    <Lucide icon="UserPlusIcon" class="w-[28px] h-[28px] text-pending" />
                    <div class="ml-auto">
                      <Tippy as="div"
                  ...
                  <div class="mt-1 text-base text-slate-500">Yangi xabarlar</div>
                </div>
              </div>
            </div>
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div :class="[
                ...
                <div class="p-5 box">
                  <div class="flex">
                    <Lucide icon="UserCheckIcon" class="w-[28px] h-[28px] text-warning" style="color: #1f4f3e;" />
                    <div class="ml-auto">
                      <Tippy as="div"
                        class="cursor-pointer bg-success py-[3px] flex rounded-full text-white text-xs pl-2 pr-1 items-center font-medium"
            ...
            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
              <div :class="[
                ...
                <div class="p-5 box">
                  <div class="flex">
                    <Lucide icon="UserXIcon" class="w-[28px] h-[28px] text-success" style="color: brown;" />
                    <div class="ml-auto">
                      <Tippy as="div"
                        class="cursor-pointer bg-success py-[3px] flex rounded-full text-white text-xs pl-2 pr-1 items-center font-medium"
      ...
      <div class="pb-10 -mb-10 2xl:border-l">
        <div class="grid grid-cols-12 2xl:pl-6 gap-x-6 2xl:gap-x-0 gap-y-6">
          ...
          <div
            ...
            <div class="flex items-center h-10 intro-x">
              <h2 class="mr-5 text-lg font-medium truncate">Kalendar</h2>
