        ...
        <Table.Tbody>
          <Table.Tr v-for="(faker, fakerKey) in _.take(fakerData, 9)" :key="fakerKey" class="intro-x">
            ...
            <Table.Td
              ...
              <div v-if="faker.trueFalse[0]" class="text-slate-500 text-xs whitespace-nowrap mt-0.5">
                Ohio, Ohio
              </div>
              <div v-else class="text-slate-500 text-xs whitespace-nowrap mt-0.5">
                California, LA
              </div>
            </Table.Td>
            <Table.Td
            ...
            <Table.Td :class="[
              ...
              <div class="flex items-center justify-center">
                <a class="flex items-center mr-5 text-primary whitespace-nowrap" href="#">
                  <Lucide icon="CheckSquare" class="w-4 h-4 mr-1" /> View
                  Details
                </a>
                <a class="flex items-center text-primary whitespace-nowrap" href="#" @click="
                  (event) => {
