...
const openCameraModal = async (rowData: any) => {
  ...
  await nextTick(); // DOM yuklanishini kutamiz
  ...
  try {
    ...
    alert("Kamera ochilmadi: " + (err as Error).message);
...
const takePhoto = async () => {
  ...
  const base64Image = canvas.toDataURL("image/jpeg"); // Bu yerda base64 olinadi
