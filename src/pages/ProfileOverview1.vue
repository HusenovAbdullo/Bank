...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Profil ma'lumotlari</h2>
  </div>
  <Tab.Group>
    <!-- BEGIN: Profile Info -->
      ...
      <div class="flex flex-col pb-5 -mx-5 border-b lg:flex-row border-slate-200/60 dark:border-darkmode-400">
        <div class="flex items-center justify-center flex-1 px-5 lg:justify-start">
          <div class="relative flex-none w-20 h-20 sm:w-24 sm:h-24 lg:w-32 lg:h-32 image-fit">
            <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" :src="fakerData[0].photos[0]" />
            <div
        ...
        <div
          ...
          <div class="flex flex-col items-center justify-center mt-4 lg:items-start">
            ...
            <div class="flex items-center mt-3 truncate sm:whitespace-normal">
              <Lucide icon="PhoneIcon" class="w-4 h-4 mr-2" /> Instagram
              {{ fakerData[0].users[0].name }}
            </div>
      ...
      <Tab.Panel>
        <div class="grid grid-cols-12 gap-6">
          ...
          <!-- <Tab.Group class="col-span-12 intro-y box lg:col-span-6">
            <div class="flex items-center px-5 py-5 border-b sm:py-0 border-slate-200/60 dark:border-darkmode-400">
                ...
                <Tab.Panel>
                  <div>
                    ...
                    <Progress class="h-1 mt-2">
                      <Progress.Bar class="w-1/2 bg-primary" role="progressbar" :aria-valuenow="0" :aria-valuemin="0"
                        :aria-valuemax="100"></Progress.Bar>
                    </Progress>
                  </div>
                  <div class="mt-5">
                    <div class="flex">
                    ...
                    <Progress class="h-1 mt-2">
                      <Progress.Bar class="w-1/4 bg-primary" role="progressbar" :aria-valuenow="0" :aria-valuemin="0"
                        :aria-valuemax="100"></Progress.Bar>
                    </Progress>
                  </div>
                  <div class="mt-5">
                    ...
                    <Progress class="h-1 mt-2">
                      <Progress.Bar class="w-3/4 bg-primary" role="progressbar" :aria-valuenow="0" :aria-valuemin="0"
                        :aria-valuemax="100"></Progress.Bar>
                    </Progress>
                  </div>
                  <Button as="a" variant="secondary" href="" class="block w-40 mx-auto mt-5">
                    View More Details
                  </Button>
                </Tab.Panel>
              </Tab.Panels>
          ...
          <!-- <div class="col-span-12 intro-y box lg:col-span-6">
            ...
            <div class="p-5">
              ...
              <div class="relative flex items-center mt-5">
                <div class="flex-none w-12 h-12 image-fit">
                  <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" :src="fakerData[1].photos[0]" />
                </div>
                <div class="ml-4 mr-auto">
                  <a href="" class="font-medium">
              ...
              <div class="relative flex items-center mt-5">
                <div class="flex-none w-12 h-12 image-fit">
                  <img alt="Midone Tailwind HTML Admin Template" class="rounded-full" :src="fakerData[2].photos[0]" />
                </div>
                <div class="ml-4 mr-auto">
                  <a href="" class="font-medium">
